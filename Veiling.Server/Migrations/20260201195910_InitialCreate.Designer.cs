...
namespace Veiling.Server.Migrations
{
    ...
    [Migration("20260201195910_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aankoop", b =>
                {
                    ...
                    b.HasIndex("BodId")
                        .IsUnique()
                        .HasFilter("[BodId] IS NOT NULL");

                    b.ToTable("Aankopen", "identity");
                });
            ...
            modelBuilder.Entity("Aankoop", b =>
                {
                    b.HasOne("Veiling.Server.Models.Bod", "Bod")
                        .WithOne("Aankoop")
                        .HasForeignKey("Aankoop", "BodId")
            ...
            modelBuilder.Entity("Veiling.Server.Models.Bod", b =>
                {
                    ...
                    b.HasOne("Veiling.Server.Models.Kavel", null)
                        .WithMany("Boden")
            ...
            modelBuilder.Entity("Veiling.Server.Models.KavelVeiling", b =>
                {
                    b.HasOne("Veiling.Server.Models.Bod", "Bod")
                        .WithOne("KavelVeiling")
                        .HasForeignKey("Veiling.Server.Models.KavelVeiling", "BodId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Veiling.Server.Models.Bod", b =>
                {
                    b.Navigation("Aankoop");

                    b.Navigation("KavelVeiling");
                });
