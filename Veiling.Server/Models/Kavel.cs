namespace Veiling.Server.Models
{
    public class Kavel
    {
        ...
        public string ArtikelKenmerken { get; set; } = string.Empty; // wat wordt hiermee bedoeld
        ...
        public int HoeveelheidContainers { get; set; } // moet erbij komen
        public int AantalProductenPerContainer { get; set; } // moet erbij komen
        public float LengteVanBloemen { get; set; } // moet erbij komen
        public float GewichtVanBloemen { get; set; }  // moet erbij komen
        public string StageOfMaturity { get; set; } = string.Empty; // moet erbij komen
